package com.maxrocky.scheduledtask;
...
public class ScheduledTaskDemo {
     ...
     *  2.使用cron属性可按照指定时间执行，本例指的是每天10点30分到12点20分每隔10分钟执行一次；cron是UNIX和类UNIX(Linux)系统下的定时任务
     */
    ...
    public void reportCurrentTime(){
        System.out.println("每五秒执行一次：" + dateTimeFormatter.format(LocalDateTime.now()));
    }

    @Scheduled(cron = "0 30/10 10-12 ? * *")
